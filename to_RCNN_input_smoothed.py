...
for regfile in regfiles:
	...
	if os.path.isfile(filepath) == False:
		...
		##gauss2d = Gaussian2DKernel (x_stddev=std)
		#print (gauss2d.array)
		#print("image dimensions: ", np.array(inverted_image).ndim)
		##gauss3d = np.stack([gauss2d, gauss2d, gauss2d])
		#print(gauss3d)
		#print('kernel dimensions: ', gauss3d.ndim)
		##smoothed_image = convolve(np.array(inverted_image), kernel = gauss3d)
		##print(type(inverted_image))
		#smoothed_image = Image.fromarray(np.uint8(smoothed_image)).convert('RGB')
		#smoothed_image = Image.fromarray(smoothed_image).convert('RGB')
		##smoothed_image = Image.fromarray((smoothed_image * 255).astype(np.uint8)).convert('RGB')
		##plt.imshow(smoothed_image)
		##plt.show()
		##smoothed_image.save(filepath)
	...
	imageitem["annotations"] = annotations0
